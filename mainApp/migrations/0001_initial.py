    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('p_category', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='mainApp.category')),
                ('p_special_status', models.ManyToManyField(blank=True, to='mainApp.specialstatus')),
            ],
        ),
        migrations.CreateModel(
